...
const initialData: SalesRow[] = [
  {
    ...
    broker: 'Mitch',
    bcCompleted: 'Yes',
    dateOfPvfReview: 'Tuesday, 21 January 2025',
    dateOfPropertySelection: '28/01/2025 - Sale',
    dateOfContractSigning: '19/02/2023 - Contracts Signed',
    dateOfFinanceAppointment: '30/01/2025 - Completed',
  },
  {
    id: '2',
    dateOfConsultation: 'Friday, 17 January 2025',
    client: 'De Santis',
    strategist: 'Tim',
    consultant: 'Spencer',
    creditAnalyst: 'Zim',
    broker: 'Jules',
    bcCompleted: 'Yes',
    dateOfPvfReview: 'Wednesday, 22 January 2025',
    dateOfPropertySelection: '29/01/2025 - Sale',
    dateOfContractSigning: '',
    dateOfFinanceAppointment: '04/02/2025 - Completed',
  },
];
...
const Sales = () => {
  const [data, setData] = useState<SalesRow[]>(initialData);

  const updateCell = (id: string, field: keyof SalesRow, value: string) => {
        ...
        <SidebarInset className="flex flex-col">
          <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-slate-600">Sales</h1>
              <p className="text-sm text-slate-600">Successful property sales and completed transactions</p>
            </div>
          </header>
