...
interface MissTableRowProps {
  row: MissRow;
  updateCell: (id: string, field: keyof MissRow, value: string) => void;
  staffOptions: string[];
  getStaffColor: (staff: string) => string;
}

const MissTableRow = ({ row, updateCell, staffOptions, getStaffColor }: MissTableRowProps) => {
  return (
